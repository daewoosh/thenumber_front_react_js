...
const saveRecommendation = (params) => {
    const res = ajaxReq('AcceptOpenIISAccountRecommendation', 'POST', {}, true)
    return res;
}

const rejectRecommendation = (params) => {
    const res = ajaxReq('RejectOpenIISAccountRecommendation', 'POST', params, true)
    return res;
}
...
@observer
export class IISAccountRecommendation extends React.Component {
    constructor(props) {
        super(props);
    }
